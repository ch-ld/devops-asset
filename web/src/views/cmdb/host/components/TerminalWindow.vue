    ...
    >
      <div class="terminal-toolbar">
        ...
        <div class="terminal-actions">
          <a-tooltip title="调整字体大小">
            <a-button-group>
              <a-button @click="decreaseFontSize" :disabled="terminalPrefs.font_size <= 10">
                <template #icon><font-size-outlined /></template>
                -
              </a-button>
              <a-button>{{ terminalPrefs.font_size }}px</a-button>
              <a-button @click="increaseFontSize" :disabled="terminalPrefs.font_size >= 24">
                <template #icon><font-size-outlined /></template>
                +
              </a-button>
            </a-button-group>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const primaryIP = computed(() => {
      ...
      try {
        const ipList = typeof props.host.public_ip === 'string' 

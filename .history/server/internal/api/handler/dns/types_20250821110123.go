...
type DomainGroupResponse struct {
	...
	DomainCount      int                    `json:"domain_count,omitempty" example:"5" comment:"直接归属域名数量"`
	TotalDomainCount int                    `json:"total_domain_count,omitempty" example:"15" comment:"包含子分组的总域名数量"`
...
type CertificateResponse struct {
	...
	DomainID        *uint           `json:"domain_id" example:"1" comment:"域名ID（可选）"`

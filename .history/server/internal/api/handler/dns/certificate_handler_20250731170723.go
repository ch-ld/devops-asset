...
func (h *CertificateHandler) IssueCertificate(c *gin.Context) {
	...
	if err != nil {
		response.ReturnError(c, response.INTERNAL_ERROR, "申请证书失败: "+err.Error())
		return
	}
	...
	certResp := &CertificateResponse{
		...
		ValidFrom:    cert.ValidFrom.Format("2006-01-02T15:04:05Z"),
		ValidTo:      cert.ValidTo.Format("2006-01-02T15:04:05Z"),
		AutoRenew:    cert.AutoRenew,
		LastRenewed:  cert.LastRenewed.Format("2006-01-02T15:04:05Z"),
...
func (h *CertificateHandler) GetCertificate(c *gin.Context) {
	...
	cert := &CertificateResponse{
		...
		AutoRenew:    true,
		LastRenewed:  "2024-01-01T00:00:00Z",
		RenewCount:   0,

...
func (h *CertificateHandler) RenewCertificate(c *gin.Context) {
	...
	certResp := &CertificateResponse{
		...
		TenantID:   newCert.TenantID,
		CreatedBy:  userID.(uint),
		CreatedAt:  newCert.CreatedAt.Format("2006-01-02T15:04:05Z"),
		UpdatedAt:  newCert.UpdatedAt.Format("2006-01-02T15:04:05Z"),
	}

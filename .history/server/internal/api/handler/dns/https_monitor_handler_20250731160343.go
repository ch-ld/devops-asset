...
func (h *HTTPSMonitorHandler) CreateMonitor(c *gin.Context) {
	...
	if err != nil {
		response.ReturnError(c, response.INTERNAL_ERROR, "创建监控失败: "+err.Error())
		return
	}
...
func (h *HTTPSMonitorHandler) UpdateMonitor(c *gin.Context) {
	...
	response.ReturnSuccess(c, "更新监控成功")
}
...
func (h *HTTPSMonitorHandler) DeleteMonitor(c *gin.Context) {
	...
	if err != nil {
		response.ReturnError(c, response.INTERNAL_ERROR, "删除监控失败: "+err.Error())
		return
	}

	response.ReturnSuccess(c, "删除监控成功")
}
...
func (h *HTTPSMonitorHandler) CheckMonitor(c *gin.Context) {
	...
	if err != nil {
		response.ReturnError(c, response.INTERNAL_ERROR, "检查监控失败: "+err.Error())
		return
	}
...
func (h *HTTPSMonitorHandler) GetMonitorStatistics(c *gin.Context) {
	...
	if err != nil {
		response.ReturnError(c, response.INTERNAL_ERROR, "获取统计信息失败: "+err.Error())
		return
	}

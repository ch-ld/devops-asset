...
func (h *DomainGroupHandler) CreateDomainGroup(c *gin.Context) {
	...
	// 创建域名分组
	if err := h.domainGroupService.CreateDomainGroup(group); err != nil {
...
func (h *DomainGroupHandler) UpdateDomainGroup(c *gin.Context) {
	...
	// 更新域名分组
	if err := h.domainGroupService.UpdateDomainGroup(group); err != nil {
...
func (h *DomainGroupHandler) DeleteDomainGroup(c *gin.Context) {
	...
	// 删除域名分组
	if err := h.domainGroupService.DeleteDomainGroup(uint(groupID), tenantID.(uint)); err != nil {

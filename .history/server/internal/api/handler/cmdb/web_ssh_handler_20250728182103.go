...
import (
	...
	"devops-asset/server/internal/model/cmdb"
	"devops-asset/server/internal/repository/cmdb"
	"devops-asset/server/pkg/ssh"
...
func NewWebSshHandler(hostRepo cmdb.HostRepository) *WebSshHandler {

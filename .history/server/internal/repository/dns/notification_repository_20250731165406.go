...
// Create 创建通知
func (r *NotificationRepository) Create(notification *dns.Notification) error {
	return r.DB.Create(notification).Error
}

// Update 更新通知
func (r *NotificationRepository) Update(notification *dns.Notification) error {
	return r.DB.Model(notification).Updates(notification).Error
}

// Delete 删除通知
func (r *NotificationRepository) Delete(id uint) error {
	return r.DB.Delete(&dns.Notification{}, id).Error
}

// FindByID 根据ID查找通知
func (r *NotificationRepository) FindByID(id uint) (*dns.Notification, error) {
	var notification dns.Notification

...
func InitDnsRoutes(r *gin.RouterGroup, db *gorm.DB) {
	...
	dnsGroup := r.Group("/dns")
	{
		...
		// 导入导出与模板
		dnsGroup.POST("/import-export/records/import", recordImpExpHandler.ImportRecordsFromJSON)
		dnsGroup.POST("/import-export/records/export", recordImpExpHandler.ExportRecords)

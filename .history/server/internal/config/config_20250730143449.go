...
type RegistrationConfig struct {
	Enabled         bool `yaml:"enabled"`          // 是否开启注册
	RequireApproval bool `yaml:"require_approval"` // 是否需要审批
	DefaultRoleID   uint `yaml:"default_role_id"`  // 默认角色ID
}
...
var (
	...
	RegistrationDefaultRoleID   uint
...
func setCompatibilityVars() {
	...
	// 注册相关
	RegistrationEnabled = GlobalConfig.Registration.Enabled
	RegistrationRequireApproval = GlobalConfig.Registration.RequireApproval
	RegistrationDefaultRoleID = GlobalConfig.Registration.DefaultRoleID

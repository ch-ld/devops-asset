    ...
    <div class="main-content">
      <el-card class="form-card">
        ...
        >
          ...
          <!-- CSR上传区域 -->
          <template v-if="formData.applyType === 'csr'">
            <el-divider content-position="left">
...
const formRules = {
  ...
  csrFile: [
    { required: true, message: '请上传CSR文件', trigger: 'change' }
  ]
}
...
const certValidation = ref(null)
const csrValidation = ref(null)
...
const canSubmit = computed(() => {
  ...
  } else if (formData.applyType === 'upload') {
    return formData.certFile && formData.keyFile
  } else if (formData.applyType === 'csr') {
    return formData.csrFile && formData.email
  }
  return false
})

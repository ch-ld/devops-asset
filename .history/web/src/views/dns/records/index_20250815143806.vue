      ...
      <div class="header-content">
        ...
        <div class="header-right">
          ...
          <template v-if="viewMode === 'detail'">
            <el-button type="default" size="large" :disabled="!selectedDomain" @click="handleExportAll">
              <el-icon><Download /></el-icon>
              导出
            </el-button>
            <el-button type="default" size="large" :disabled="!selectedDomain" @click="openImportModal">
              <el-icon><Upload /></el-icon>
              导入
            </el-button>
            <el-button type="primary" size="large" @click="handleAddRecord" :disabled="!selectedDomain">
              <el-icon><Plus /></el-icon>
              添加记录
            </el-button>
            <el-button type="primary" plain size="large" @click="() => bulkVisible = true" :disabled="!selectedDomain">
              批量添加
            </el-button>
          </template>
          <template v-else>
            <el-button type="primary" size="large" @click="handleAddDomain">
              <el-icon><Plus /></el-icon>
              添加域名
            </el-button>
          </template>
...
const fetchDomainRecordCounts = async () => {
  ...
  try {
    ...
    // resp 是以字符串 key 的对象，转换为 number key
    const map: Record<number, number> = {}
    Object.keys(resp as any).forEach(k => {
      const id = Number(k)
      map[id] = (resp as any)[k] as number
    })

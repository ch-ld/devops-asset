      ...
      <template #header>
        <div class="table-header">
          ...
          <div class="table-actions">
            <el-button type="primary" @click="handleCreate" class="action-btn primary-btn">
              <el-icon><Plus /></el-icon>
              新增提供商
            </el-button>
            ...
            <div class="connection-status">
              ...
              >
                <el-icon class="connection-icon">
                  <component :is="row.lastTestResult.success ? 'CircleCheck' : 'CircleClose'" />
                </el-icon>

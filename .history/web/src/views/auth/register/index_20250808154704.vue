      ...
      <div class="card-header">
        ...
        <div class="devops-visual" aria-hidden="true">
          <svg viewBox="0 0 560 90" class="devops-svg">
            ...
            <path d="M20 45 C 90 10, 140 10, 200 45 S 320 80, 360 45 460 10, 540 45" fill="none" stroke="url(#g1)" stroke-width="2.5" stroke-linecap="round" stroke-dasharray="6 10" class="pipeline-path" />
...
.devops-svg { width: 100%; height: 90px; filter: url(#softGlow); }
.pipeline-path { animation: dashMove 12s linear infinite; opacity: 0.8; }
@keyframes dashMove { to { stroke-dashoffset: -320; } }
.node .node-bg { fill: rgba(99,102,241,0.08); stroke: rgba(99,102,241,0.3); stroke-width: 1; }
.node .icon { fill: url(#g1); }
.node .icon-stroke { stroke: url(#g1); stroke-width: 1.6; }

    ...
    <div class="hero-section">
      ...
      <div class="hero-content">
        <div class="hero-title">
          <h1>专注于用户体验的后台管理系统模板</h1>
          <p>美观实用的界面，经过现代化改造，带给用户极致的体验</p>
        </div>
        ...
        <div class="devops-illustration">
          <svg viewBox="0 0 600 400" class="illustration-svg">
            ...
            <!-- 开发阶段 -->
            <g class="stage" transform="translate(50, 80)">
              <circle cx="0" cy="0" r="25" fill="url(#primaryGrad)" filter="url(#glow)"/>
              <path d="M-12 -8 L-4 -8 L-4 -16 L12 0 L-4 16 L-4 8 L-12 8 Z" fill="white"/>
              <text x="0" y="45" text-anchor="middle" fill="white" font-size="12" font-weight="500">开发</text>
            </g>
            
            <!-- 构建阶段 -->
            <g class="stage" transform="translate(180, 80)">
              <circle cx="0" cy="0" r="25" fill="url(#primaryGrad)" filter="url(#glow)"/>
              <rect x="-10" y="-10" width="20" height="20" rx="2" fill="white"/>
              <rect x="-6" y="-6" width="12" height="4" fill="url(#primaryGrad)"/>
              <rect x="-6" y="-1" width="8" height="3" fill="url(#primaryGrad)"/>
              <rect x="-6" y="3" width="10" height="3" fill="url(#primaryGrad)"/>
              <text x="0" y="45" text-anchor="middle" fill="white" font-size="12" font-weight="500">构建</text>
            </g>
            
            <!-- 测试阶段 -->
            <g class="stage" transform="translate(310, 80)">
              <circle cx="0" cy="0" r="25" fill="url(#secondaryGrad)" filter="url(#glow)"/>
              <circle cx="0" cy="0" r="8" fill="none" stroke="white" stroke-width="2"/>
              <path d="M-5 -2 L-2 2 L6 -6" stroke="white" stroke-width="2" fill="none" stroke-linecap="round"/>
              <text x="0" y="45" text-anchor="middle" fill="white" font-size="12" font-weight="500">测试</text>
            </g>
            
            <!-- 部署阶段 -->
            <g class="stage" transform="translate(440, 80)">
              <circle cx="0" cy="0" r="25" fill="url(#secondaryGrad)" filter="url(#glow)"/>
              <rect x="-8" y="-8" width="16" height="12" rx="2" fill="white"/>
              <rect x="-6" y="-6" width="12" height="2" fill="url(#secondaryGrad)"/>
              <rect x="-6" y="-3" width="12" height="2" fill="url(#secondaryGrad)"/>
              <rect x="-6" y="0" width="12" height="2" fill="url(#secondaryGrad)"/>
              <circle cx="0" cy="8" r="2" fill="white"/>
              <text x="0" y="45" text-anchor="middle" fill="white" font-size="12" font-weight="500">部署</text>
            </g>
            
            <!-- 连接线 -->
            <path d="M 75 80 Q 127 80 155 80" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none" stroke-dasharray="5,5">
              <animate attributeName="stroke-dashoffset" values="0;-10" dur="1s" repeatCount="indefinite"/>
            </path>
            <path d="M 205 80 Q 257 80 285 80" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none" stroke-dasharray="5,5">
              <animate attributeName="stroke-dashoffset" values="0;-10" dur="1s" repeatCount="indefinite"/>
            </path>
            <path d="M 335 80 Q 387 80 415 80" stroke="rgba(255,255,255,0.6)" stroke-width="2" fill="none" stroke-dasharray="5,5">
              <animate attributeName="stroke-dashoffset" values="0;-10" dur="1s" repeatCount="indefinite"/>
            </path>
            ...
            <g class="data-flow">
              <circle r="3" fill="#1890ff" opacity="0.8">
                <animateMotion dur="3s" repeatCount="indefinite" path="M50,80 Q180,60 310,80 Q440,100 550,80"/>
              </circle>
              <circle r="2" fill="#722ed1" opacity="0.6">
                <animateMotion dur="4s" repeatCount="indefinite" path="M50,80 Q180,100 310,80 Q440,60 550,80"/>
              </circle>
            </g>
          </svg>
        </div>

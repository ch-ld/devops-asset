  ...
  <div class="auth-container">
    ...
    <div class="auth-card">
      ...
      <div class="card-body">
        ...
        <div class="divider"><span>或 使用企业登录</span></div>
        <div class="sso-row">
          <ElButton class="sso-button github" plain @click="ssoLogin('github')">
          ...
          <ElButton class="sso-button gitlab" plain @click="ssoLogin('gitlab')">
            <span class="icon" aria-hidden="true">
          ...
          <ElButton class="sso-button ldap" plain @click="ssoLogin('ldap')">
            <span class="icon" aria-hidden="true">
...
<script setup lang="ts">
  ...
  const ssoLogin = (provider: 'github' | 'gitlab' | 'ldap') => {
    const map: Record<string, string> = {
      github: 'GitHub 单点登录即将上线',
      gitlab: 'GitLab 单点登录即将上线',
      ldap: 'LDAP/AD 企业登录即将上线'
    }

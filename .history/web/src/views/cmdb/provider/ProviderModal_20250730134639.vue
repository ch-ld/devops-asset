...
/* 确保下拉框在模态框中正确显示 */
.region-select-form-item :deep(.el-select) {
  width: 100% !important;
}

.region-select-form-item :deep(.el-select .el-input__wrapper) {
  background-color: #ffffff !important;
  border: 1px solid #dcdfe6 !important;
}

.region-select-form-item :deep(.el-select .el-input__wrapper:hover) {
  border-color: #c0c4cc !important;
}

.region-select-form-item :deep(.el-select.is-focused .el-input__wrapper) {

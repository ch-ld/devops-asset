...
onMounted(async () => {
  ...
  // 修复分页下拉框快速消失问题
  setTimeout(() => {
    const paginationSelects = document.querySelectorAll('.el-pagination .el-select')
...
/* 分页下拉菜单修复 - 专门解决快速消失问题 */
:global(.el-pagination .el-select) {
  z-index: 1000 !important;
}

:global(.el-pagination .el-select .el-select__wrapper) {
  position: relative;
  z-index: 1000;
}
...
:global(.el-pagination .el-select-dropdown) {
  z-index: 99999 !important;
...
/* 当鼠标在下拉框内时，保持显示 */
:global(.el-select-dropdown:hover) {
  opacity: 1 !important;
...
/* 专门为分页组件的select添加保持显示的样式 */
:global(.el-pagination .el-select:hover .el-select-dropdown),
:global(.el-pagination .el-select .el-select-dropdown:hover) {
  opacity: 1 !important;
  visibility: visible !important;
...
:global(.el-select-dropdown.pagination-dropdown .el-select-dropdown__item:hover) {
  background-color: #f5f7fa !important;
  color: #409eff !important;
}

:global(.el-select-dropdown.pagination-dropdown .el-select-dropdown__item.selected) {
  background-color: #409eff !important;
...
<!-- 全局样式修复 Element Plus 下拉框定位问题 -->
<style>
/* 修复 Element Plus 下拉框在弹窗中的定位问题 */
.el-select-dropdown {
  position: fixed !important;

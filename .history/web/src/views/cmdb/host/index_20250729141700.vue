      ...
      <div class="main-content">
        ...
        <div class="pagination-container" id="pagination-container">
          <el-pagination
            ...
            append-size-to="#pagination-container"
...
/* 修复分页下拉菜单定位问题 - 确保下拉菜单出现在分页器附近 */
.el-select-dropdown.pagination-dropdown {
...
.el-select-dropdown.pagination-dropdown .el-select-dropdown__item {
...
.el-select-dropdown.pagination-dropdown .el-select-dropdown__item:last-child {
  border-bottom: none !important;
}

.el-select-dropdown.pagination-dropdown .el-select-dropdown__item:hover {
  background-color: #f5f7fa !important;
  color: #409eff !important;
}

.el-select-dropdown.pagination-dropdown .el-select-dropdown__item.selected {
  background-color: #409eff !important;
  color: #ffffff !important;
}

/* 全局样式 - 确保所有分页下拉菜单都能正确显示 */
:global(.el-select-dropdown.pagination-dropdown) {
  position: absolute !important;
  z-index: 2000 !important;
  max-height: 200px !important;
  overflow-y: auto !important;
...
:global(.el-select-dropdown.pagination-dropdown .el-select-dropdown__item) {
  padding: 10px 16px !important;
  font-size: 14px !important;
  line-height: 1.5 !important;
  white-space: nowrap !important;
...
:global(.el-select-dropdown.pagination-dropdown .el-select-dropdown__item:last-child) {
  border-bottom: none !important;
}

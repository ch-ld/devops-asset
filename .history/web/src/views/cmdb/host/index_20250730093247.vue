...
/* 修复分页下拉框弹出方向 - 强制向上弹出 */
.pagination-container .el-pagination .el-select .el-select-dropdown,
.el-pagination .el-pagination__sizes .el-select .el-select-dropdown,
.el-select-dropdown[data-popper-placement^="top"] {
...
/* 全局强制分页下拉框向上弹出 */
body .el-pagination .el-select .el-select-dropdown {
  transform: translateY(-100%) translateY(-8px) !important;
  top: auto !important;
  bottom: 100% !important;
  margin-bottom: 8px !important;
...
/* 使用最高优先级强制向上弹出 */
[class*="el-pagination"] .el-select .el-select-dropdown {
  transform: translateY(-100%) translateY(-8px) !important;
  top: auto !important;
  bottom: 100% !important;
  margin-bottom: 8px !important;

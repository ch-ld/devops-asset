      ...
      <div class="terminal-toolbar">
        <div class="terminal-info">
          ...
          <div class="connection-status">
            ...
            <span v-if="connectionStatus === 'connected'" class="connection-time">
              连接时间: {{ connectionTime }}
            </span>
          </div>
        </div>
...
const connectWebSocket = () => {
  ...
  const wsUrl = `${protocol}//${window.location.host}/api/v1/ws/terminal?host_id=${props.host.id}&token=${token}`

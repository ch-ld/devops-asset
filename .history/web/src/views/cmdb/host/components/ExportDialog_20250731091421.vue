          ...
          <div class="field-group">
            ...
            <div class="field-list">
              <el-checkbox-group v-model="formData.fields">
                ...
                <el-checkbox value="username">SSH用户名</el-checkbox>
                <el-checkbox value="port">SSH端口</el-checkbox>
                <el-checkbox value="auth_type">认证方式</el-checkbox>
                ...
                <el-checkbox value="provider_id">云厂商ID</el-checkbox>
              </el-checkbox-group>
            </div>
          </div>
          ...
          <div class="field-group">
            ...
            <div class="field-list">
              <el-checkbox-group v-model="formData.fields">
                ...
                <el-checkbox value="ssh_status">SSH状态</el-checkbox>
                <el-checkbox value="last_connected_at">最后连接时间</el-checkbox>
                <el-checkbox value="connection_timeout">连接超时</el-checkbox>
                <el-checkbox value="expired_at">过期时间</el-checkbox>
                <el-checkbox value="extra_fields">自定义字段</el-checkbox>
...
const formData = reactive<ExportFormData>({
  scope: 'all',
  format: 'excel',
  fields: ['name', 'instance_id', 'status', 'public_ip', 'private_ip', 'configuration', 'os', 'region']
})

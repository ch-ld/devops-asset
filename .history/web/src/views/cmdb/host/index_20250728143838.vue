        ...
        <div class="modern-header">
          <div class="header-main">
            ...
            <div class="header-actions">
              ...
              <el-button class="action-btn secondary-btn" @click="showBatchImportDialog">
                <el-icon><Upload /></el-icon>
                <span>批量导入</span>
              </el-button>
              <el-button class="action-btn secondary-btn" @click="handleBatchExport">
...
.modern-search-input :deep(.el-input__wrapper.is-focus) {
  background: white !important;
  border-color: #4f46e5 !important;
  box-shadow: 0 0 0 4px rgba(79, 70, 229, 0.1), 0 4px 12px rgba(0, 0, 0, 0.08) !important;
}

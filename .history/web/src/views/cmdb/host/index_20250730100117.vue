          ...
          <div class="pagination-wrapper">
            ...
            <div class="page-size-selector">
              ...
              <el-select 
                ...
                style="width: 80px;"
                :teleported="true"
                popper-class="custom-page-size-dropdown"
              >
                <el-option v-for="size in [10, 20, 30, 50, 100]" :key="size" :value="size" :label="`${size}条`" />
              </el-select>
            </div>
...
/* 自定义页面大小下拉框样式 */
:global(.custom-page-size-dropdown) {

<template>
  <div class="host-management-page">
      ...
      <el-row :gutter="16" align="middle">
        ...
        <el-col :lg="6" :md="24" :sm="24" :xs="24" style="text-align: right">
          <div class="el-space--horizontal" style="gap: 8px; display: flex">
            ...
            <el-button type="primary" plain @click="openAddGroup">+ 主机组</el-button>
          </div>
        </el-col>
      </el-row>
    </el-card>
    ...
    <host-group-modal
      ref="hostGroupModalRef"
      :host-groups="hostStore.hostGroupTree"
...
<script setup>
  ...
  const hostGroupModalRef = ref(null)
  const openAddGroup = () => {
    hostGroupModalRef.value?.open()
  }
